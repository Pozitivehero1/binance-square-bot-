...
MIN_POST_QUALITY = float(os.getenv("MIN_POST_QUALITY", "78"))
    ...
    *,
    ...
    for index, draft in enumerate(drafts):
        try:
            ...
            # Reward a strong first line and an underused editorial family.
            editorial_bonus = 2.0 if draft.content_format not in recent_formats[-6:] else 0.0
            adjusted_score = report.score - similarity_penalty - novelty_penalty + editorial_bonus
            logger.info(
    ...
    try:
        if PUBLISH_IMAGES:
            card_visuals = {
                ...
                "indicator_card", "data_card", "followup_card",
            }
