...
class PublicationGuard:
    def __init__(self, memory_items: Optional[Iterable[dict]] = None, path: Optional[Path] = None):
        ...
        self.enable_reach_gate = os.getenv("ENABLE_REACH_GATE", "0").strip().lower() in {"1", "true", "yes", "on"}
        ...
        self.min_reach_score = max(0.0, min(100.0, float(os.getenv("MIN_REACH_SCORE", "0"))))
