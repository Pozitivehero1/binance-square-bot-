...
from writer import generate_post_candidates, _ticker_count
...
def _test_mistral_fact_lock() -> None:
    ...
    for draft in drafts:
        assert draft.style_id.startswith("ai_")
        assert draft.content_format in {"contrarian_take", "data_brief", "indicator_lesson", "level_story"}
        ...
        assert report.valid, report.reasons
    print("MISTRAL FACT LOCK: OK | one request | 4 editorial formats | fact-locked")
