...
1. Краткий анализ текущей ситуации (что движет ценой, технические уровни, настроение).
...
- Длина 500–700 символов. где уместо добавляй смайлы
...
"""
    ...
    # Защита от случайного форматирования
    for ch in ['*', '_', '`', '#']:
