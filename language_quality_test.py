...
BAD = [
    ...
    "$ZEC — цена увеличилась на +++ за последние пять минут.",
    "The市场目前显示出积极的短期动能, цена продолжает движение.",
    "$REZ проходит по уровню текущего цены внутри диапазона.",
    "Объём вырос вдвое почти двенадцать раз по сравнению со средним.",
]
