...
plan duplication at publish time, and keeps all v11.3 outcome semantics intact.
"""
...
def _patch_writer() -> bool:
    ...
    changed |= _replace_optional(
        ...
        label="production plan sanitizer import",
    )
...
def apply_v1145_hotfix() -> None:
    ...
    changed = _patch_writer() | _patch_publisher() | _patch_main()
    if changed:
        print("[v11.4.5 hotfix] Production Guard applied: canonical single plan + final structural gate")
    else:
